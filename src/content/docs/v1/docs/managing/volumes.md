---
title: Volumes
description: Persistent ext4 volumes — attach semantics, mount restrictions, and
  the detached-state requirement.
slug: v1/docs/managing/volumes
---
...
The CLI surface is in [Volumes reference](/v1/docs/reference/cli/volumes/). This page covers the rules — when you can attach, what mount paths are allowed, and which operations require the volume to be unattached.
...
* [`bhatti volume delete`](/v1/docs/reference/cli/volumes/delete/)
* [`bhatti volume resize`](/v1/docs/reference/cli/volumes/resize/)
* [`bhatti volume clone`](/v1/docs/reference/cli/volumes/clone/)
* [`bhatti volume restore`](/v1/docs/reference/cli/volumes/restore/)

The server returns `409 Conflict` if any sandbox has the volume mounted. To detach, either destroy the sandbox or [`bhatti stop`](/v1/docs/reference/cli/sandbox/stop/) it (stopping detaches volumes; starting reattaches).

[`bhatti volume backup`](/v1/docs/reference/cli/volumes/backup/) is the exception — it works while the volume is attached. The trade-off is consistency: writes in flight at backup time may be captured mid-update. For a guaranteed-clean backup, stop the sandbox first.
...
Schedule regular backups with retention via the `backup.schedule` config — see [Configuration](/v1/docs/reference/config/#backup).

## See also

* [Volumes reference](/v1/docs/reference/cli/volumes/) — every command
* [`bhatti create --volume`](/v1/docs/reference/cli/sandbox/create/) — attach syntax
* [Configuration: backup](/v1/docs/reference/config/#backup) — S3 setup
