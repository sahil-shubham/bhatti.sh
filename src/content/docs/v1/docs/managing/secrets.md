...
The CLI surface lives in [Secrets reference](/v1/docs/reference/cli/secrets/). This page covers the *model* — what's encrypted, what isn't, and the rules for which env var wins when multiple sources set the same name.
...
When a [cold sandbox wakes](/v1/docs/under-the-hood/thermal-states/#cold--hot):
...
cache](/v1/docs/under-the-hood/storage/#cold-wake-and-the-page-cache).
...
* [Secrets reference](/v1/docs/reference/cli/secrets/) — `set`, `list`, `delete`
* [`bhatti create --secret`](/v1/docs/reference/cli/sandbox/create/) — inject at sandbox boot
