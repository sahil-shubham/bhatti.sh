...
sidebar:
  label: image list
  order: 1
slug: v1/docs/reference/cli/images/list
---
...
* [`bhatti image pull`](/v1/docs/reference/cli/images/pull/) / [`import`](/v1/docs/reference/cli/images/import/) / [`save`](/v1/docs/reference/cli/images/save/)
* [API: `GET /images`](/v1/docs/reference/api/#list-images)
