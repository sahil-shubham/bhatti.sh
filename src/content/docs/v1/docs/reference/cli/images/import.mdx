...
sidebar:
  label: image import
  order: 3
slug: v1/docs/reference/cli/images/import
---
...
* [`bhatti image pull`](/v1/docs/reference/cli/images/pull/) — server-side pull from public registries (no Docker needed)
* [`bhatti image save`](/v1/docs/reference/cli/images/save/) — save a sandbox's filesystem as an image
* [API: `POST /images/import`](/v1/docs/reference/api/#import-an-image)
