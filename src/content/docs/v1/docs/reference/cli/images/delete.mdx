...
sidebar:
  label: image delete
  order: 5
slug: v1/docs/reference/cli/images/delete
---
...
* [`bhatti image list`](/v1/docs/reference/cli/images/list/)
* [API: `DELETE /images/:name`](/v1/docs/reference/api/#delete-an-image)
