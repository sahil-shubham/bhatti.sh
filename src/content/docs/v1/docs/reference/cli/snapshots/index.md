---
title: Snapshots
description: Named VM snapshots that capture memory, CPU, and disk. Resume into
  a new sandbox at any time.
sidebar:
  label: Overview
  order: 0
slug: v1/docs/reference/cli/snapshots
---
...
| Command | Description |
| ------- | ----------- |
| [`bhatti snapshot create`](/v1/docs/reference/cli/snapshots/create/) | Checkpoint a running sandbox. |
| [`bhatti snapshot list`](/v1/docs/reference/cli/snapshots/list/) | List your snapshots. |
| [`bhatti snapshot resume`](/v1/docs/reference/cli/snapshots/resume/) | Resume from a snapshot into a new sandbox. |
| [`bhatti snapshot delete`](/v1/docs/reference/cli/snapshots/delete/) | Delete a snapshot. |
