...
sidebar:
  ...
  order: 3
slug: v1/docs/reference/cli/snapshots/resume
---
...
* [`bhatti snapshot create`](/v1/docs/reference/cli/snapshots/create/) — make the snapshot
* [`bhatti snapshot list`](/v1/docs/reference/cli/snapshots/list/) — find snapshot names
* [API: `POST /snapshots/:name/resume`](/v1/docs/reference/api/#resume-a-snapshot)
