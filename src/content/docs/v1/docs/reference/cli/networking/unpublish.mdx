...
sidebar:
  label: unpublish
  order: 2
slug: v1/docs/reference/cli/networking/unpublish
---
...
* [`bhatti publish`](/v1/docs/reference/cli/networking/publish/)
* [API: `DELETE /sandboxes/:id/publish/:port`](/v1/docs/reference/api/#unpublish-a-port)
