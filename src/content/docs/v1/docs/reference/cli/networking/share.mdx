...
sidebar:
  label: share
  order: 3
slug: v1/docs/reference/cli/networking/share
---
...
**Behaviour in the browser.** The page opens an xterm.js terminal connected via WebSocket; it's a full PTY session, identical to [`bhatti shell`](/v1/docs/reference/cli/exec/shell/). Closing the tab detaches; the session keeps running and scrollback is preserved. Reopening the URL reattaches.
...
* [`bhatti publish --shell`](/v1/docs/reference/cli/networking/publish/) — preview URL + share URL in one call
* [`bhatti shell`](/v1/docs/reference/cli/exec/shell/) — terminal-based interactive shell
* [`bhatti shell`](/v1/docs/reference/cli/exec/shell/) — the CLI counterpart
* [API: `POST /sandboxes/:id/shell-token`](/v1/docs/reference/api/#mint-a-shell-token)
