...
sidebar:
  label: secret set
  order: 1
slug: v1/docs/reference/cli/secrets/set
---
...
* [`bhatti create --secret`](/v1/docs/reference/cli/sandbox/create/) — inject the secret into a sandbox at boot
* [API: `POST /secrets`](/v1/docs/reference/api/#create-or-update-a-secret)
