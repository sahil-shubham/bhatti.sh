...
sidebar:
  label: volume delete
  order: 3
slug: v1/docs/reference/cli/volumes/delete
---
...
* [`bhatti volume list`](/v1/docs/reference/cli/volumes/list/) — find current attachments
* [API: `DELETE /volumes/:name`](/v1/docs/reference/api/#delete-a-volume)
