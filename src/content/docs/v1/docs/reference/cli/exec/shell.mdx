---
title: bhatti shell
description: Open an interactive shell inside a sandbox. Detach with Ctrl+\,
  reattach later, scrollback preserved.
sidebar:
  label: shell
  order: 2
slug: v1/docs/reference/cli/exec/shell
---
...
* [`bhatti exec`](/v1/docs/reference/cli/exec/exec/) — non-interactive command execution
* [`bhatti ps`](/v1/docs/reference/cli/exec/ps/) — list active sessions including this shell
* [`bhatti share`](/v1/docs/reference/cli/networking/share/) — browser-based shell URL
* [API: `GET /sandboxes/:id/ws`](/v1/docs/reference/api/#interactive-shell-websocket)
