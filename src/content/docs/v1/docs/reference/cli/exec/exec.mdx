---
title: bhatti exec
description: Execute a command inside a sandbox. Streaming or buffered output,
  optional timeout, optional detach.
sidebar:
  label: exec
  order: 1
slug: v1/docs/reference/cli/exec/exec
---
...
* [`bhatti shell`](/v1/docs/reference/cli/exec/shell/) — interactive shell with reattach
* [`bhatti ps`](/v1/docs/reference/cli/exec/ps/) — see detached / running sessions
* [API: `POST /sandboxes/:id/exec`](/v1/docs/reference/api/#run-a-command)
