...
sidebar:
  label: serve
  order: 1
slug: v1/docs/reference/cli/admin/serve
---
...
This command takes no flags. Configuration is via `/etc/bhatti/config.yaml`. See [Configuration](/v1/docs/reference/config/).
...
* [Configuration](/v1/docs/reference/config/)
* [Self-hosting](/v1/docs/self-hosting/)
