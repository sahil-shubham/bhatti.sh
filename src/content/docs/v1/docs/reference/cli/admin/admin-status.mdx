...
sidebar:
  label: admin status
  order: 10
slug: v1/docs/reference/cli/admin/admin-status
---
...
* [`bhatti admin events`](/v1/docs/reference/cli/admin/admin-events/) — drill into the event log
* [`bhatti admin metrics`](/v1/docs/reference/cli/admin/admin-metrics/) — time-series view
