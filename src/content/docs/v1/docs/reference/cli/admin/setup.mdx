---
title: bhatti setup
description: Configure the CLI's API endpoint and key. Saves to
  ~/.bhatti/config.yaml. Interactive by default; --url and --token make it
  scriptable.
sidebar:
  label: setup
  order: 2
slug: v1/docs/reference/cli/admin/setup
---
...
See [Global flags](/v1/docs/reference/cli/#global-flags) for `--url`,
...
[Configuration precedence](/v1/docs/reference/cli/#configuration-precedence).

## See also

* [`bhatti version`](/v1/docs/reference/cli/admin/version/) — check
  connection without changing config
* [`bhatti user create`](/v1/docs/reference/cli/admin/user-create/) —
  create a user and get an API key (server-side, run by the
  operator)
* [`bhatti completion`](/v1/docs/reference/cli/admin/completion/) —
  shell completions
* [Configuration](/v1/docs/reference/config/) — full file format
