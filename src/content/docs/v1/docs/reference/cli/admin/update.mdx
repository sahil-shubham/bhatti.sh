...
sidebar:
  label: update
  order: 4
slug: v1/docs/reference/cli/admin/update
---
...
* [`bhatti version`](/v1/docs/reference/cli/admin/version/) — check current version + latest release
* [Self-hosting](/v1/docs/self-hosting/) — initial install
* [Updating](/v1/docs/updating/) — upgrade and uninstall guide
