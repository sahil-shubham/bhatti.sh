...
sidebar:
  label: version
  order: 3
slug: v1/docs/reference/cli/admin/version
---
...
* [`bhatti update`](/v1/docs/reference/cli/admin/update/) — apply available updates
* [`bhatti admin status`](/v1/docs/reference/cli/admin/admin-status/) — also prints version info on the server side
