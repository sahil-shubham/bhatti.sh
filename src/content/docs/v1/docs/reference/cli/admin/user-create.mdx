...
sidebar:
  label: user create
  order: 6
slug: v1/docs/reference/cli/admin/user-create
---
...
* An **API key** (`bht_<64-hex>`) — printed once, then only its SHA-256 hash is stored. **Save the key immediately**; it can't be recovered. Use [`user rotate-key`](/v1/docs/reference/cli/admin/user-rotate-key/) if it's lost.
...
* [`bhatti user list`](/v1/docs/reference/cli/admin/user-list/)
* [`bhatti user rotate-key`](/v1/docs/reference/cli/admin/user-rotate-key/) — replace a lost or compromised key
* [Users & auth](/v1/docs/managing/users/) — broader narrative on multi-tenant setup
