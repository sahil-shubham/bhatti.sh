...
sidebar:
  label: admin events
  order: 11
slug: v1/docs/reference/cli/admin/admin-events
---
...
* [`bhatti admin status`](/v1/docs/reference/cli/admin/admin-status/) — shows the most recent ~10 events inline
* [`bhatti admin metrics`](/v1/docs/reference/cli/admin/admin-metrics/) — counter-based view
