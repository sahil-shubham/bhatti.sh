...
sidebar:
  label: admin metrics
  order: 12
slug: v1/docs/reference/cli/admin/admin-metrics
---
...
`--since` accepts the same formats as [`admin events --since`](/v1/docs/reference/cli/admin/admin-events/) — relative durations or absolute dates. The default is **1 hour**.
...
* [`bhatti admin status`](/v1/docs/reference/cli/admin/admin-status/) — current totals
* [`bhatti admin events`](/v1/docs/reference/cli/admin/admin-events/) — what happened, when
