...
sidebar:
  label: completion
  order: 5
slug: v1/docs/reference/cli/admin/completion
---
...
* [`bhatti setup`](/v1/docs/reference/cli/admin/setup/) — `setup` detects your shell and prints the right snippet automatically.
