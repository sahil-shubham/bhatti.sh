...
sidebar:
  label: edit
  order: 4
slug: v1/docs/reference/cli/sandbox/edit
---
...
* [`bhatti create --keep-hot`](/v1/docs/reference/cli/sandbox/create/) — set this at creation
* [Thermal states](/v1/docs/under-the-hood/thermal-states/) — how hot/warm/cold transitions work
* [API: `PATCH /sandboxes/:id`](/v1/docs/reference/api/#update-a-sandbox)
