...
sidebar:
  label: list
  order: 2
slug: v1/docs/reference/cli/sandbox/list
---
...
* [`bhatti inspect`](/v1/docs/reference/cli/sandbox/inspect/) — full details for a single sandbox
* [`bhatti ps`](/v1/docs/reference/cli/exec/ps/) — sessions inside a sandbox
* [API: `GET /sandboxes`](/v1/docs/reference/api/#list-sandboxes)
