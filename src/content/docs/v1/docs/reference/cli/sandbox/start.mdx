...
sidebar:
  label: start
  order: 6
slug: v1/docs/reference/cli/sandbox/start
---
...
* [`bhatti stop`](/v1/docs/reference/cli/sandbox/stop/) — snapshot and stop
* [Thermal states](/v1/docs/under-the-hood/thermal-states/) — automatic resume
* [API: `POST /sandboxes/:id/start`](/v1/docs/reference/api/#start-a-sandbox)
