...
sidebar:
  label: inspect
  order: 3
slug: v1/docs/reference/cli/sandbox/inspect
---
...
* [`bhatti list`](/v1/docs/reference/cli/sandbox/list/) — list all sandboxes
* [`bhatti edit`](/v1/docs/reference/cli/sandbox/edit/) — change mutable settings
* [API: `GET /sandboxes/:id`](/v1/docs/reference/api/#get-a-sandbox)
