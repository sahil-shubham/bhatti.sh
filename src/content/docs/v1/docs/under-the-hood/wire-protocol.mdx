...
description: Binary framing between host and guest — frame format, frame types,
  atomic writes, kill semantics, and the choices that shaped it.
slug: v1/docs/under-the-hood/wire-protocol
---
...
This is why the [piped exec](/v1/docs/under-the-hood/lohar-the-blacksmith/#piped-exec-the-simpler-path)
...
[Lohar's systemctl IPC](/v1/docs/under-the-hood/lohar-the-blacksmith/#privileged-systemctl-from-a-non-root-caller).
...
[the lohar story](/v1/docs/under-the-hood/lohar-the-blacksmith/#why-not-real-systemd)
for why.
...
[Sessions](/v1/docs/under-the-hood/lohar-the-blacksmith/#sessions)).
...
[config drive](/v1/docs/under-the-hood/lohar-the-blacksmith/#boot-sequence)
...
[the explanation in lohar.md](/v1/docs/under-the-hood/lohar-the-blacksmith/#file-operations) —
...
| **EXEC\_KILL API** | `SIGKILL` to process group | Explicit force-kill by session ID. |
...
* [Architecture](/v1/docs/under-the-hood/architecture/) — the bigger
  picture of host ↔ guest communication
* [Decisions & learnings](/v1/docs/under-the-hood/decisions/) — including
