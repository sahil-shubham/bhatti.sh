...
description: A 10-minute mental model of bhatti — what runs where, what state
  lives where, and the four structural decisions that shape everything else.
slug: v1/docs/under-the-hood/architecture
---

This page is the map. It exists so that when you go into
[Lohar](/v1/docs/under-the-hood/lohar-the-blacksmith/),
[Thermal states](/v1/docs/under-the-hood/thermal-states/),
[Networking](/v1/docs/under-the-hood/networking/), or
[Decisions](/v1/docs/under-the-hood/decisions/), you already have a
...
[Storage](/v1/docs/under-the-hood/storage/) for the cost-by-filesystem
...
* [Lohar — the agent inside every VM](/v1/docs/under-the-hood/lohar-the-blacksmith/)
  — PID 1, the systemctl shim, sessions, file ops
* [Thermal states](/v1/docs/under-the-hood/thermal-states/) — hot /
  warm / cold, the balloon trick, snapshot mechanics
* [Networking](/v1/docs/under-the-hood/networking/) — per-user bridges,
  the six iptables rules, the ARP trick, kernel `ip=`
* [Wire protocol](/v1/docs/under-the-hood/wire-protocol/) — frame
  format, all frame types, atomic writes
* [Firecracker engine internals](/v1/docs/under-the-hood/engine/) —
