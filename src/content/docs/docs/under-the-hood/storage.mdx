---
title: Storage
description: How bhatti stores sandbox state on disk — reflinks, compression, page cache, and why btrfs is the recommended filesystem.
---
...
state](/docs/under-the-hood/thermal-states/), its `mem.snap` is the
...
(recommended: btrfs)](/docs/self-hosting/#filesystem-recommended-btrfs)
